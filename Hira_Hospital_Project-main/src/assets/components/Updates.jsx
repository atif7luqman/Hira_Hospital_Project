      ...
      <Row xs={1} md={3} className="g-4">
        ...
        <Col md={4} className="align-self-center text-center">
          <div className="d-flex flex-column align-items-center">
            <HeartFilled className='fs-1 text-danger' />
            <span className="fw-bold fs-1 text-dark" style={{ color: '#2359F4' }}>99%</span>
            <span className="fs-6 text-danger">positive feedback</span>
          </div>
        </Col>
